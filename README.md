...
generator.sh,initialize_user.sh :you should modify the dir of woboq cobrowser, the raw project,the temp project pulled
from gitlab, and the generated html file
